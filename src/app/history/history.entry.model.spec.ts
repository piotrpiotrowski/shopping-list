...
describe('HistoryEntry', () => {
  ...
  it('should ignore empty list', () => {
    //given
    const historyEntry = new HistoryEntry('key', [new Item(1, "n", "c", 1)], false);
  ...
  it('should append item which is not on the list', () => {
    ...
    //when
    const updatedHistoryEntry = historyEntry.appendItems([new Item(2, "o", "c", 1)]);
  ...
  it('should append item which is on the list', () => {
    //given
    const historyEntry = new HistoryEntry('key', [new Item(1, "n", "c", 1, "no1")], false);

    //when
    const updatedHistoryEntry = historyEntry.appendItems([new Item(1, "n", "c", 2, "no2")]);
