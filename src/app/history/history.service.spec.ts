...
describe('HistoryService', () => {
  ...
  it('should add a new list of items', () => {
    ...
    //then
    expect(localStorage.getItem(buildKey())).toEqual('[{"id":1,"name":"n","category":"c","quantity":1,"note":"","state":"NOT_CHECKED"}]');
  ...
  it('should append to existing list of items', () => {
    ...
    //then
    expect(localStorage.getItem(buildKey())).toEqual('[{"id":1,"name":"n","category":"c","quantity":1,"note":"","state":"NOT_CHECKED"},{"id":2,"name":"a","category":"c","quantity":2,"note":"","state":"NOT_CHECKED"}]');
  ...
  it('should merge items with the same name', () => {
    ...
    //then
    expect(localStorage.getItem(buildKey())).toEqual('[{"id":1,"name":"n","category":"c","quantity":3,"note":"no1, no2","state":"NOT_CHECKED"}]');
